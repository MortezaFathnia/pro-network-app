...
import { IconDashboard, IconDoorExit, IconSettings, IconStar, IconUser, IconUserCircle } from "@tabler/icons-react";
...
export default function AppShellContainer({ children,user }: { children: ReactNode;user:any }) {
