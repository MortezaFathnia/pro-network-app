                ...
                <tbody>
                    {usersToSkills.map((userToSkill) => (
                        <tr key={userToSkill.skill.id}>
                            <td className="border-slate-600 p-2 border-t">{userToSkill.skill.name}</td>
                            <td className="border-slate-600 p-2 border-t"><SkillRatingForm rating={userToSkill.rating || 0} skillId={userToSkill.skillId} /></td>
                            <td className="border-slate-600 p-2 border-t"><DeleteUserToSkillBtn skillId={userToSkill.skillId}/></td>
                        </tr>
                    ))}
                </tbody>
            </table>
