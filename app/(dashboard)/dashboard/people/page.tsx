import PaginitionContainer from "@/components/pagination-container";
...
interface Props { searchParams: { page: number } }
...
export default async function Page({ searchParams }: Props) {
    ...
    return (
        <div className="flex flex-col gap-5">
            ...
            <PaginitionContainer total={res.numPages} value={page} />
        </div>
    )
